...
export async function fetchAIResponse(textForAI, context, myUsername, type = "rewrite") {
    const finalPrompt = `
Ты — ИИ-ассистент, который помогает продавцу "${myUsername}" на FunPay. Твоя задача — переписать его черновик сообщения, сохранив основной смысл, но сделав его более вежливым, профессиональным и четким.
...
5.  СТИЛЬ: Используй вежливый, но уверенный тон. Добавляй уместные эмодзи для дружелюбности, но без излишеств.
