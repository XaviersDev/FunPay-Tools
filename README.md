...
| **Умное авто-поднятие лотов** | Расширение само читает ответ серверов FunPay ("подождите ещё 12 минут") и ставит таймер секунда в секунду. Никаких лишних запросов и багов с лимитами. Фильтр по категориям и наличию автовыдачи. |
| **Уведомления в Discord** | Webhook-оповещения с пингом @everyone / @here. |
| **Статистика продаж** | Аналитика за любой период. Добавлены умные задержки при загрузке огромной истории продаж для предотвращения ошибки 429 Too Many Requests. |
